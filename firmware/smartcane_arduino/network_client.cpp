...
static void putDistanceCm(DynamicJsonDocument &doc,
                          const char *cmKey,
                          const char *validKey,
                          int cm,
                          bool valid) {
...
static void putDistanceReadings(DynamicJsonDocument &doc, const DistanceReadings &distances) {
  putDistanceCm(doc, "front_cm", "front_valid", distances.frontCm, distances.frontValid);
  putDistanceCm(doc, "left_cm", "left_valid", distances.leftCm, distances.leftValid);
  putDistanceCm(doc, "right_cm", "right_valid", distances.rightCm, distances.rightValid);
  putDistanceCm(doc, "down_cm", "down_valid", distances.downCm, distances.downValid);
}
...
bool uploadRiskEvent(const char *riskType,
  ...
  putDistanceReadings(doc, distances);
