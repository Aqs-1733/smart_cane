...
// Device and backend.
#define SMARTCANE_BUILD_TAG "arduino-step-realtime-vertical-fall-short-cue-20260813"
...
#define SMARTCANE_EVENT_HTTP_TIMEOUT_MS 300
#define SMARTCANE_SENSOR_FRAME_HTTP_TIMEOUT_MS 350
